...
- To see the code, download and unzip codebase.zip, or just clone the above GitHub repo
...
- SSH into the VM, upload the server.zip file on Vocareum onto the VM, and unzip it
    ...
    - To compile it yourself, clone and open the repo as a Maven project and build it
